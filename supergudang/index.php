  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo ($_GET['url'] === 'inventory') ? 'active' : ''; ?>" href="index.php?url=inventory">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-warehouse text-warning text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Gudang Mentah</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php echo ($_GET['url'] === 'inventory5') ? 'active' : ''; ?>" href="index.php?url=inventory5">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-warehouse text-primary text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Gudang Mateng</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php echo ($_GET['url'] === 'producttoko') ? 'active' : ''; ?>" href="index.php?url=producttoko">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-warehouse text-primary text-sm opacity-10"></i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo ($_GET['url'] === 'toko') ? 'active' : ''; ?>" href="index.php?url=toko">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-clipboard-list text-success text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Request Toko</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php echo ($_GET['url'] === 'preparation') ? 'active' : ''; ?>" href="index.php?url=preparation">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-dolly-flatbed text-danger text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Request Preparation</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php echo ($_GET['url'] === 'undifined') ? 'active' : ''; ?>" href="index.php?url=undifined">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-dolly-flatbed text-danger text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Undefined Product</span>
          </a>
        </li>
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Super User</h6>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php echo ($_GET['url'] === 'sign-up') ? 'active' : ''; ?>" href="index.php?url=inventory5">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-collection text-info text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Komponen List</span>
          </a>
        </li>
      </ul>
    </div>
    <div class="sidenav-footer mx-3">
      <div class="card card-plain shadow-none" id="sidenavCard">
        ...
        <div class="card-body text-center p-3 w-100 pt-0">
          <div class="docs-info">
            <h6 class="mb-0">Role : Super Gudang</h6>
            <p class="text-xs font-weight-bold mb-0">Name : Madrid</p>
          </div>
        </div>
      </div>
    </div>
